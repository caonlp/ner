...
from transformers import AdamW, DistilBertForTokenClassification
...
def train():
    ...
    for _ in trange(epochs, desc = "Epoch"):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            print("shape: ", np.array(b_input_ids).shape)
    ...
    torch.save(model, "distillbert_ner_model.pkl")


def reload_model():
    trained_model = torch.load("distillbert_ner_model.pkl")
