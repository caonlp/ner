...
from transformers import AdamW, AlbertForTokenClassification
...
def train():
    ...
    torch.save(model, "albert_ner_model.pkl")


def reload_model():
    trained_model = torch.load("albert_ner_model.pkl")
